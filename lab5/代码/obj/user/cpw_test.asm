...
obj/__user_cpw_test.out：     文件格式 elf64-littleriscv
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	63450513          	addi	a0,a0,1588 # 800668 <main+0xe0>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	63450513          	addi	a0,a0,1588 # 800688 <main+0x100>
...
exit(int error_code) {
  ...
  800140:	55450513          	addi	a0,a0,1364 # 800690 <main+0x108>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001ac:	72078793          	addi	a5,a5,1824 # 8008c8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800200:	4a8a0a13          	addi	s4,s4,1192 # 8006a4 <main+0x11c>
  ...
  80020c:	5f8c0c13          	addi	s8,s8,1528 # 800800 <error_string>
  ...
  8002fa:	6c260613          	addi	a2,a2,1730 # 8009b8 <error_string+0x1b8>
  ...
  80048e:	51e60613          	addi	a2,a2,1310 # 8009a8 <error_string+0x1a8>
  ...
  8004a0:	50460613          	addi	a2,a2,1284 # 8009a0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  8004a4:	00000417          	auipc	s0,0x0
  8004a8:	4fd40413          	addi	s0,s0,1277 # 8009a1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800534:	47140413          	addi	s0,s0,1137 # 8009a1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
int
main(void) {
  800588:	7179                	addi	sp,sp,-48
  80058a:	f022                	sd	s0,32(sp)
  80058c:	ec26                	sd	s1,24(sp)
  80058e:	f406                	sd	ra,40(sp)
    //0 - 9 
    int n,pid,code;
    int sum = 0, iscaculate = 0;
    for (n = 0; n < max_child; n ++) {
  800590:	4401                	li	s0,0
  800592:	44a9                	li	s1,10
        if((pid = fork())==0){
  800594:	bb7ff0ef          	jal	ra,80014a <fork>
  800598:	c529                	beqz	a0,8005e2 <main+0x5a>
    for (n = 0; n < max_child; n ++) {
  80059a:	2405                	addiw	s0,s0,1
  80059c:	fe941ce3          	bne	s0,s1,800594 <main+0xc>
  8005a0:	4429                	li	s0,10
    ...
    for (; n > 0; n --) {
        if (wait() != 0) {
  8005a2:	badff0ef          	jal	ra,80014e <wait>
  8005a6:	ed39                	bnez	a0,800604 <main+0x7c>
  8005a8:	347d                	addiw	s0,s0,-1
    for (; n > 0; n --) {
  8005aa:	fc65                	bnez	s0,8005a2 <main+0x1a>
            panic("wait stopped early\n");
        }
    }
    cprintf("all children below has died!\n");
  8005ac:	00000517          	auipc	a0,0x0
  8005b0:	45c50513          	addi	a0,a0,1116 # 800a08 <error_string+0x208>
  8005b4:	aedff0ef          	jal	ra,8000a0 <cprintf>
    if((pid = fork())==0){
  8005b8:	b93ff0ef          	jal	ra,80014a <fork>
  8005bc:	cd3d                	beqz	a0,80063a <main+0xb2>
        }
  ...
  8005c0:	b97ff0ef          	jal	ra,800156 <waitpid>
  8005c4:	e939                	bnez	a0,80061a <main+0x92>
    yield();
  8005c6:	b95ff0ef          	jal	ra,80015a <yield>
    cprintf("test pass.\n");
  8005ca:	00000517          	auipc	a0,0x0
  8005ce:	4de50513          	addi	a0,a0,1246 # 800aa8 <error_string+0x2a8>
  ...
  8005dc:	4501                	li	a0,0
  8005de:	6145                	addi	sp,sp,48
  8005e0:	8082                	ret
            cprintf("Child %d born!\n",n);
  8005e2:	85a2                	mv	a1,s0
  8005e4:	00000517          	auipc	a0,0x0
  8005e8:	3dc50513          	addi	a0,a0,988 # 8009c0 <error_string+0x1c0>
  8005ec:	ab5ff0ef          	jal	ra,8000a0 <cprintf>
            cprintf("Child %d died!\n",n);
  8005f0:	85a2                	mv	a1,s0
  8005f2:	00000517          	auipc	a0,0x0
  8005f6:	3de50513          	addi	a0,a0,990 # 8009d0 <error_string+0x1d0>
  8005fa:	aa7ff0ef          	jal	ra,8000a0 <cprintf>
            exit(0);
  8005fe:	4501                	li	a0,0
  800600:	b35ff0ef          	jal	ra,800134 <exit>
            panic("wait stopped early\n");
  800604:	00000617          	auipc	a2,0x0
  800608:	3dc60613          	addi	a2,a2,988 # 8009e0 <error_string+0x1e0>
  80060c:	45d5                	li	a1,21
  80060e:	00000517          	auipc	a0,0x0
  800612:	3ea50513          	addi	a0,a0,1002 # 8009f8 <error_string+0x1f8>
  800616:	a11ff0ef          	jal	ra,800026 <__panic>
    assert(waitpid(pid, &code) == 0);
  80061a:	00000697          	auipc	a3,0x0
  80061e:	45668693          	addi	a3,a3,1110 # 800a70 <error_string+0x270>
  800622:	00000617          	auipc	a2,0x0
  800626:	46e60613          	addi	a2,a2,1134 # 800a90 <error_string+0x290>
  80062a:	02500593          	li	a1,37
  80062e:	00000517          	auipc	a0,0x0
  800632:	3ca50513          	addi	a0,a0,970 # 8009f8 <error_string+0x1f8>
  800636:	9f1ff0ef          	jal	ra,800026 <__panic>
        cprintf("let a child caculate sum from 0 to 9\n");
  80063a:	00000517          	auipc	a0,0x0
  80063e:	3ee50513          	addi	a0,a0,1006 # 800a28 <error_string+0x228>
  800642:	a5fff0ef          	jal	ra,8000a0 <cprintf>
        cprintf("caculate over\n");
  800646:	00000517          	auipc	a0,0x0
  80064a:	40a50513          	addi	a0,a0,1034 # 800a50 <error_string+0x250>
  80064e:	a53ff0ef          	jal	ra,8000a0 <cprintf>
        cprintf("sum :%d\n",sum);
  800652:	02d00593          	li	a1,45
  800656:	00000517          	auipc	a0,0x0
  80065a:	40a50513          	addi	a0,a0,1034 # 800a60 <error_string+0x260>
  80065e:	a43ff0ef          	jal	ra,8000a0 <cprintf>
        exit(0);
  800662:	4501                	li	a0,0
  800664:	ad1ff0ef          	jal	ra,800134 <exit>
